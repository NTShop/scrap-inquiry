<?php
/**
 * New scrap enquiry email class file
 *
 ...
 * Class
 */
class Email_Scrap_Enquiry_New extends \WC_Email {
	...
	public function __construct() {
		...
		$this->id          = 'scrap_enquiry_new';
		$this->title       = __( 'Scrap Enquiry - New', 'scrap-enquiry' );
		$this->description = __( 'Notification sent to admin for a new scrap enquiry', 'scrap-enquiry' );
		$this->heading     = __( 'New Scrap Enquiry', 'scrap-enquiry' );
		$this->subject     = __( 'New Scrap Enquiry', 'scrap-enquiry' );
		$this->manual      = false;
		...
		add_action( 'new_scrap_enquiry', array( $this, 'trigger' ), 10, 1 );
	}
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'subject'    => array(
				...
				'placeholder' => __( 'New scrap enquiry: {enquiry_id}', 'scrap-enquiry' ),
			...
			'heading'    => array(
				...
				'placeholder' => __( 'New scrap enquiry', 'scrap-enquiry' ),
			...
			'message'    => array(
				...
				'placeholder' => '',
				'default'     => __( 'You have a new scrap enquiry.', 'scrap-enquiry' ) . "\n\n" . '{url}' . "\n" . '{scrap_details}' . "\n",
			),
	...
	public function trigger( $scrap_id ) {
		...
		// Send email.
		$this->setup_and_send( $this->get_recipient(), $message, $subject, $scrap_id );
	}
