<?php
/**
 * Email class file for when customer clicks Reject link
 *
 ...
 * Class
 */
class Email_Scrap_Enquiry_Rejected extends \WC_Email {
	...
	public function __construct() {
		...
		$this->id          = 'scrap_enquiry_rejected';
		$this->title       = __( 'Scrap Enquiry - Rejected', 'scrap-enquiry' );
		$this->description = __( 'Notification sent to admin is scrap quote is rejected by the customer', 'scrap-enquiry' );
		$this->heading     = __( 'Scrap Enquiry Rejected', 'scrap-enquiry' );
		$this->subject     = __( 'Scrap Enquiry Rejected', 'scrap-enquiry' );
		$this->manual      = false;
		...
		add_action( 'scrap_enquiry_rejected', array( $this, 'trigger' ), 10, 1 );
	}
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'message'    => array(
				...
				'placeholder' => '',
				'default'     => __( 'Offer rejected.', 'scrap-enquiry' ) . "\n\n" . '{url}' . "\n" . '{scrap_details}' . "\n",
			),
